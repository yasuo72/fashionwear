  ...
  return (
    <Link href={`/category/${id}`}>
      <div className="group relative cursor-pointer">
        {/* Subtle Glow Border */}
        <div className="absolute -inset-0.5 bg-primary/40 rounded-2xl blur opacity-0 group-hover:opacity-75 transition duration-500"></div>
          ...
          <div className="relative aspect-square overflow-hidden">
            ...
            <div className="absolute inset-0 p-6 flex flex-col justify-end">
              <div className="transform transition-all duration-300 group-hover:translate-y-0 translate-y-2">
                <div className="inline-flex items-center gap-2 bg-black/40 backdrop-blur-md border border-white/20 rounded-full px-3 py-1 mb-3">
